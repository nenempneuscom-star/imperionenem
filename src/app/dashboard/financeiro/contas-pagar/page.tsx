  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button asChild>
          <Link href="/dashboard/financeiro/contas-pagar/nova">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className={resumo.valorVencido > 0 ? 'border-red-500' : ''}>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {resumo.vencidas} conta(s) vencida(s)
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {resumo.aVencer} conta(s) a vencer
            </p>
          </CardContent>
        </Card>
                  ...
                  <TableRow key={conta.id}>
                    ...
                    <TableCell className="text-right">
                      <Button variant="ghost" size="sm" asChild>
                        <Link href={`/dashboard/financeiro/contas-pagar/${conta.id}`}>
                          Detalhes
                        </Link>
                      </Button>
                    </TableCell>
